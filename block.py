...
class Block:
    ...
    def __str__(self):
        ...
        # Problem Statement 3.b.iii
        # Add _version
        # added line 40 in this file for this purpose

        # Problem Statement 3.a.i
        # Add _transaction_counter
        # added line 41 in this file for this purpose
    ...
    # added a new function to fetch the hash of the previous block
    # so that it can be used during block validation
...
if __name__ == "__main__":
    ...
    new_block = Block(index=10, transactions=transactions, previous_block_hash=previous_block_hash, difficulty_level=5)
