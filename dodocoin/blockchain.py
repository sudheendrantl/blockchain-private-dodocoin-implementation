...
class DodoCoin:
    ...
    def __create_genesis_block(self):
        ...
        self._genesis_block = Block(index=0, transactions=[], previous_block_hash=0, difficulty_level=4, version=3,
    ...
    # Added new function.
    # the difficulty level can be dynamically altered during run-time
    # by calling this method and modifying its value
